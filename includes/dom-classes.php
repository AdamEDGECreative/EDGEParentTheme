...
add_filter( 'body_class', 'et_remove_body_classes', 10, 2 );
add_filter( 'body_class', 'et_add_post_name_as_body_class', 10, 2 );
 ...
 * @return array
 */
function et_remove_body_classes( $wp_classes, $extra_classes ) {
  $blacklist = array(
    'error404',
  );
 ...
 * @return array
 */
function et_add_post_name_as_body_class( $wp_classes, $extra_classes ) {  
  global $post;
