...
<ul>
	...
	<?php if ( $googleplus_url = get_field( 'googleplus_url', 'options' ) ): ?>
		...
		<li>
			<a href="<?php echo $googleplus_url; ?>">
				...
				<span class="u-visually-hidden">Follow us on Google+</span>
			</a>
		</li>
	...
	<?php if ( $youtube_url = get_field( 'youtube_url', 'options' ) ): ?>
		...
		<li>
			<a href="<?php echo $youtube_url; ?>">
				...
				<span class="u-visually-hidden">Subscribe to us on YouTube</span>
			</a>
		</li>
